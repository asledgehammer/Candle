...
--- @param arg1 Vector3f
--- @return Vector3f
--- @overload fun(self: Vector3fc, arg0: float, arg1: float, arg2: float, arg3: Vector3f): Vector3f
...
--- @return float
--- @overload fun(self: Vector3fc, arg0: float, arg1: float, arg2: float, arg3: float, arg4: float, arg5: float): float
...
--- @param arg0 Vector3fc
--- @return float
--- @overload fun(self: Vector3fc, arg0: float, arg1: float, arg2: float): float
...
--- @param arg1 float
--- @return boolean
--- @overload fun(self: Vector3fc, arg0: float, arg1: float, arg2: float): boolean
...
--- @overload fun(self: Vector3fc, arg0: int, arg1: ByteBuffer): ByteBuffer
--- @overload fun(self: Vector3fc, arg0: int, arg1: FloatBuffer): FloatBuffer
--- @overload fun(self: Vector3fc, arg0: int, arg1: Vector3i): Vector3i
...
--- @param arg1 Vector3f
--- @return Vector3f
--- @overload fun(self: Vector3fc, arg0: Matrix4fc, arg1: float, arg2: Vector3f): Vector3f
...
--- @param arg0 Vector3f
--- @return Vector3f
--- @overload fun(self: Vector3fc, arg0: float, arg1: Vector3f): Vector3f
...
--- @return Quaternionf
--- @overload fun(self: Vector3fc, arg0: float, arg1: float, arg2: float, arg3: Quaternionf): Quaternionf
